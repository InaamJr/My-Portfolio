const socialLinks = [
    ...
    {
        href: "https://www.instagram.com/inaam.jr/",
        icon: (
            <svg
                width="25"
                height="24"
        ...
        <section id="contact" className="section pb-20">
            <div className="container">
                ...
                <div className="reveal-up mb-8 flex items-end justify-between gap-6">
                    <div>
                        <p className="text-xs tracking-[0.35em] text-zinc-400/80 uppercase font-mono">
                            Let’s build something
                        </p>
                        <h2 className="headline-2 mt-3">Contact</h2>
                    </div>
        
                    <div className="hidden md:flex items-center gap-2 text-xs text-zinc-400">
                        <span className="inline-flex items-center gap-2 px-3 py-2 rounded-full ring-1 ring-inset ring-zinc-800/70 bg-zinc-950/40">
                            <span className="inline-block w-1.5 h-1.5 rounded-full bg-sky-400" />
                            Fast replies • Clean builds
                        </span>
                    </div>
                </div>
                ...
                <div className="lg:grid lg:grid-cols-2 lg:items-stretch lg:gap-8">
                    ...
                    <div className="mb-10 lg:mb-0 lg:flex lg:flex-col">
                        <h3 className="reveal-up text-[18px] md:text-[20px] font-medium tracking-wide text-zinc-100 max-w-[22ch]">
                            Have a project in mind? Let’s collaborate.
                        </h3>
            
                        <p className="reveal-up text-zinc-400/90 font-extralight mt-3 max-w-[52ch] lg:max-w-[36ch]">
                            Tell me what you’re building, your timeline, and the vibe you want. I’ll
                            reply with the next steps.
                        </p>
            
                        {/* Social */}
                        <div className="mt-7 lg:mt-auto reveal-up">
                            <p className="font-mono text-xs tracking-[0.3em] uppercase text-zinc-400/70 mb-3">
                                Elsewhere
                            </p>
                            ...
                            <div className="flex flex-wrap items-center gap-2">
                                {socialLinks.map(({ href, icon, alt }, key) => (
                                    <a
                                        ...
                                        title={alt}
                                        className={
                                            "group relative w-12 h-12 grid place-items-center rounded-2xl " +
                                            "ring-1 ring-inset ring-zinc-800/70 bg-zinc-950/40 backdrop-blur-md " +
                                            "transition-all duration-300 hover:-translate-y-0.5 hover:ring-zinc-700/80 " +
                                            "hover:bg-white/[0.04]"
                                        }
                                    >
                                        {/* tiny glow */}
                                        <span
                                            className="pointer-events-none absolute -inset-10 opacity-0 blur-2xl transition-opacity duration-300 group-hover:opacity-100 bg-gradient-to-br from-sky-400/20 via-purple-400/10 to-transparent"
                                            aria-hidden="true"
                                        />
                
                                        <span className="relative text-zinc-200 group-hover:text-zinc-50">
                                            {icon}
                                        </span>
                                    </a>
                                ))}
                    ...
                    {/* Right / Form */}
                    <form
                        action="https://getform.io/f/ayvkdkxb"
                        method="POST"
                        className="reveal-up relative overflow-hidden rounded-3xl ring-1 ring-inset ring-zinc-800/70 bg-zinc-950/40 backdrop-blur-md"
                    >
                        {/* Ambient gradient */}
                        <div
                        ...
                        <div
                            ...
                            maskImage:
                                "radial-gradient(70% 70% at 30% 10%, black 45%, transparent 75%)",
                            }}
                            aria-hidden="true"
                        />
                        ...
                        <div className="relative p-5 sm:p-6">
                            <div className="flex items-center justify-between gap-4">
                                <p className="text-xs tracking-[0.3em] uppercase text-zinc-400/80">
                                    Quick message
                                </p>
                                <span className="text-[11px] text-zinc-400/80 px-3 py-1 rounded-full ring-1 ring-inset ring-white/[0.06] bg-white/[0.03]">
                                    No spam. Ever.
                                </span>
                            </div>
                                ...
                                <div className="md:col-span-2">
                                    <Field label="Message" htmlFor="message">
                                        <textarea
                                            ...
                                            required
                                            className="contact-input min-h-32 max-h-80 resize-y"
                                        />
                                    </Field>
                                </div>
                            </div>
                            ...
                            <button
                                type="submit"
                                className={
                                "group w-full inline-flex items-center justify-center gap-2 rounded-2xl px-5 py-3.5 " +
                                "ring-1 ring-inset ring-white/[0.08] bg-white/[0.04] backdrop-blur-md " +
                                "text-zinc-100 transition-all duration-300 hover:bg-white/[0.06] hover:-translate-y-0.5"
                                }
                            >
                                <span className="text-sm tracking-wide">Send message</span>
                                <span
                                    className="material-symbols-rounded text-[20px] transition-transform duration-300 group-hover:translate-x-0.5"
                                    aria-hidden="true"
                                >
                                    arrow_forward
                                </span>
                            ...
                            <div
                                className="pointer-events-none mt-4 h-px bg-gradient-to-r from-transparent via-white/10 to-transparent"
                                aria-hidden="true"
                            />
                                <p className="mt-4 text-[12px] text-zinc-400/80">
                                    Prefer email? <span className="text-zinc-200">inaamjr@gmail.com</span>
                                </p>
                            </div>
                        </div>
                    </form>
...
return (
    <label htmlFor={htmlFor} className="block">
        <span className="block text-xs tracking-[0.28em] uppercase text-zinc-400/80 mb-2">
            {label}
        </span>
        {children}
    </label>
